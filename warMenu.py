...
def warMinistry(myNation,year):
		...
		print('[1] higher tech level = more weapons available')
		print('[1] ..... attack enemies')
		print('[1] ..... threaten enemies for money')
		print('[2] Exit')
		print(' ')
		print(' ')
		print('****************************************')
		print(' ')
		print(' ')
		input('This Function is not ready yet, the developer is lazy...press any button to return \n')
		return(myNation)