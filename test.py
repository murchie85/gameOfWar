...
IRAN          = {'Score': 52, 'Finance':{'wealth': 100,  'gold':60, 'gems':21, 'raremetals':10,  'oil':180, 'level': 'PickPocket'}  , 'War':{'might': 40, 'level': 'private', 'weapons':{'troops':100,'tanks':10,'gunboats':30,'destroyers':5,'carriers':0,'jets':10,'bombers':3,'Nukes':0}, 'firePower':0}  , 'Tech':{'Score' : 0,'level': 0, 'science':0, 'engineering':0},  'Politics':{'leadership':0, 'stability':0} , 'Special':{'chance': 0, 'moveLimit':2, 'aggression':70, 'creativity':70, 'materialism':20, 'prudence':50, 'bonusUnits': [], 'notes': []} , 'Friendship':{} , 'Citizens':{'population': 0, 'contentment': 0, 'fertility': 0}, 'hints':'on', 'Nextmoves' : []}
